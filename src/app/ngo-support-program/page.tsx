...
export default function NGOSTupportPage() {
    const { t } = useLocale();
    ...
    return (
        <div className="flex flex-col min-h-screen font-sans">
            ...
            <main className="flex-grow">
                <section className="bg-brand-green py-24 text-white text-center rounded-b-[60px] shadow-2xl relative overflow-hidden">
                ...
                <section className="py-24 bg-white">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="max-w-4xl mx-auto space-y-12">
                            <h2 className="text-4xl font-black text-foreground">A Community of Support</h2>
                            <div className="prose prose-xl text-foreground/70 font-medium">
                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                                <div className="p-8 bg-brand-magenta/5 rounded-3xl border border-brand-magenta/10">
                                    <h3 className="text-2xl font-bold mb-4">{t.features.support.title}</h3>
