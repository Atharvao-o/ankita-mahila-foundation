                        ...
                        <div className="max-w-4xl mx-auto space-y-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
                                <div className="p-8 bg-brand-magenta/5 rounded-3xl border border-brand-magenta/10">
                                    <h3 className="text-2xl font-bold mb-4">{t.features.empower.title}</h3>
                                    <p>{t.features.empower.desc}</p>
                                </div>
                                <div className="p-8 bg-brand-gold/5 rounded-3xl border border-brand-gold/10">
                                    <h3 className="text-2xl font-bold mb-4">{t.features.uplift.title}</h3>
                                    <p>{t.features.uplift.desc}</p>
                                </div>
                            </div>
                        </div>
                    </div>
